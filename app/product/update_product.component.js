...
getInitialState : function () {
    // Get this product fields from the data attributes we set on the #content div,
    // using jQuery
    return {
        categories: [],
...
// on mount, fetch all categories and one product data to stored them as this
// component's state
